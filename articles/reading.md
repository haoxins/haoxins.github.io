...
* 前提条件: 至少是 `局部章节 (超过 1/3)` 阅读 `2次` 及以上

* Top 1: **数学 & 物理科普** - `现实不似你所见: 量子引力之旅`
* Top 1: **计算机** - `图解密码技术 第3版`

------------------

### 2021

> 下面这几本书都是 2020-08 买的, 但是呢, 估计得到 2021 才可能看完 :)
> 当然, 某些书也可能永远看不完 ~
...
* [洞见 - Why Buddhism is True?](https://book.douban.com/subject/35140470/)
  ...
  - 佛学的一些教义可以用现代科学来理解 vs 佛学的教义深刻, 并且可以去领悟
  - 感觉作者的论证目的是有摇摆的, 我觉得作者在后面的篇章中, 逐渐成为了一个 教徒
