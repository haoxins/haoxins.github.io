...
- 它们可以产生长寿命中性 `K` 介子, 它不带电荷, 没有任何一种电磁矩, 也没有自旋,
  ...
  - 是不稳定粒子, 可以衰变成一个电子 `e-`, 一个反中微子和一个正π介子 (`π+`),
  - 也可以衰变成它们的反粒子, 即一个正电子 (`e+`), 一个中微子 (`v`) 和一个负π介子 (`π-`).
...
- 我们已经讨论过, 自然界在`C`或`P`下不是对称的.
  ...
  - 然而, 我们知道, 在这三个操作的联合操作下, 自然界是严格对称的. 这称为 __CPT__ 对称性.

- 如果你把中微子拿来, 动量沿左手大拇指方向, 则中微子的自旋永远是沿左手其他四指弯曲的方向,
  我们称之为左手的中微子.
...
- 1956年还有一个重要定理, 就是 __CPT__ 总是守恒的, 所以, `CP`不对称也表明时间反演不对称.
  - 这是很奇怪的.
