...
```
一个非斜驶型的默比乌斯变换 M, 恒可分解为对圆周 A 和圆周 B 的反射,
其中 A 和 B 都正交于 M 的所有不变圆周. 此外,
视 A 和 B 为相交, 相切或不相交, M 为椭圆型, 抛物型或双曲型.

一个斜驶型默比乌斯变换 M 恒可分解为 4 个关于圆周的反射.
```
